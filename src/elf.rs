...
impl fmt::Display for ElfIdent {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        write!(
            f,
            "ElfIdent: {} {} {} {} {}",
            valid_magic, self.class, self.data, self.version, self.osabi
        )
    }
}
...
impl fmt::Display for FileHeader {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        unsafe {
            write!(
                f,
                "FileHeader: [{}] is {} for {} in version {} starts at {:x}",
                self.ident, self.elftype, self.machine, self.version, self.entry
            )
        }
    }
}
